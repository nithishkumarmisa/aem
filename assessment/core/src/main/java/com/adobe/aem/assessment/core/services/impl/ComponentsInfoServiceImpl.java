...
import com.adobe.aem.assessment.core.services.ComponentsInfoService;
import com.adobe.aem.assessment.core.utils.ResolverUtil;

@Component(immediate = true, service = ComponentsInfoService.class, name = "com.adobe.aem.assessment.core.services.ComponentsInfo", configurationPid = "com.aem.geeks.core.services.impl.ComponentsInfoImpl",
		property = {
