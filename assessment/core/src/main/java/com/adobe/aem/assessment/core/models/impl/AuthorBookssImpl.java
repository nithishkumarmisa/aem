...
import com.adobe.aem.assessment.core.models.AuthorBookss;
...
@Model(
        ...
        adapters = AuthorBookss.class,
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)
public class AuthorBookssImpl implements AuthorBookss {
    private static final Logger LOG = LoggerFactory.getLogger(AuthorBookssImpl.class);
